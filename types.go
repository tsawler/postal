...
type MailData struct {
	...
	Content      template.HTML  // The content of the message, as HTML; sent verbatim when ContentType is "text/plain".
	ContentType  string         // Optional: "text/html" (default), "text/plain" (Content sent as-is, no template), "application/xml", etc.
